...
object KillAura : Module(name = "KillAura", category = ModuleCategory.COMBAT, keyBind = Keyboard.KEY_G, defaultOn = false) {
    ...
    // CPS
    private val maxCpsValue: IntegerValue = object : IntegerValue("MaxCPS", 18, 1, 42) {
    ...
    private val minCpsValue: IntegerValue = object : IntegerValue("MinCPS", 15, 1, 40) {
        override fun onChanged(oldValue: Int, newValue: Int) {
    ...
    private val hurtTimeValue = IntegerValue("HurtTime", 15, 0, 22).displayable { attackDisplay.get() }
